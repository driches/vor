...
- Why didn't the agent comment on file X?
- Can I run this on private repos? (Yes.)
- How do I use a different model?

Please don't email for general help — Discussions are searchable and benefit other users.

## "I found a security issue"

→ See [SECURITY.md](SECURITY.md). Don't post it in a public issue or Discussion.

## "I want to contribute"

→ See [CONTRIBUTING.md](CONTRIBUTING.md). The short version: pick an issue labeled `good first issue` or `help wanted`, comment "I'll take this", and send a PR.
